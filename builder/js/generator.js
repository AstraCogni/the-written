...
<script>
// CONFIG
var CONFIG={passThreshold:${cfg.threshold},questionsPerDraw:${cfg.qcount},shuffleQ:${cfg.shuffleQ},shuffleA:${cfg.shuffleA},showAnswer:${cfg.showAnswer},retakes:${cfg.retakes},scormVersion:'${cfg.scorm}'};
